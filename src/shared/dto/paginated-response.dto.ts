 ...
 *
 * Публичные списки `{data, meta}` и `GET /comments` переведены пачкой `W9`
 * (`LEGACY-378`), голые массивы — пачками `W7` и `W9` (`LEGACY-379`). Вне этой формы
 * остались два списка аудиоглав — плоская `{items,total,page,limit,totalPages}`.
 *
