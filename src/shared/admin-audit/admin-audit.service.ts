 ...
 * (`{ role }`), у публикации и снятия версии с публикации — общий снимок лицензий
 * (`licenseSnapshotPayload`, одна форма на обе стороны истории версии), у удаления
 * пользователя `payload` нет вовсе. Общее здесь одно
