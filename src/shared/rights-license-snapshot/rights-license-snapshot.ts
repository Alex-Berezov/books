 ...
 * правообладателя. Оба обязаны гасить снимок одинаково и оба обязаны унести прежние
 * значения в неудаляемое событие той же транзакции (`LEGACY-180`, решение владельца
 * 12.09.2026: гасить).
 *
