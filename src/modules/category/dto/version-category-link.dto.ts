 ...
 *
 * 🔴 `LEGACY-005`. Поле `isPrimary` снято из ответа релизом 1 (`v1.0.97`); колонки больше
 * нет вовсе — её сняли три релиза 19.09.2026, последний миграцией
 * `20260919160000_legacy_005_drop_isprimary_column` (`ADR-018`,
