 ...
 * сироты видит внешние ключи, строковые колонки-адреса, текст с HTML редактора и Json
 * (`media/media-references.ts`, LEGACY-413, LEGACY-421), а stage 2 перепроверяет ссылки перед
 * удалением файла. Включение — осознанное
