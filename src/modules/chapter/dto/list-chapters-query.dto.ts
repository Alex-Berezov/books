 ...
 * 13.09.2026). Он остаётся, пока его ждут два живых потребителя: админский
 * экран глав в `books-front` (`api/endpoints/admin/chapters.ts`) зовёт маршрут
 * без параметров и разбирает голый массив. Обязательная пагинация здесь —
