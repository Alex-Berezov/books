...
### Этап 1: Подготовка и проверка (10 мин)

**Задачи:**

- [ ] Проверить доступность сервера 209.74.88.183
- [ ] Убедиться что приложение работает на localhost:5000
- [ ] Проверить SSH доступ к серверу
- [ ] Протестировать созданные в Итерации 6 скрипты
...
- ✅ SSH доступ работает
- ✅ Приложение отвечает HTTP 200 на /api/health/liveness
- ✅ Все скрипты исполняются без ошибок

### Этап 2: Настройка DNS в Namecheap (15 мин)

**Задачи:**

- [ ] Войти в панель управления Namecheap
- [ ] Удалить URL Forward для bibliaris.com (КРИТИЧНО!)
- [ ] Добавить A-record: @ → 209.74.88.183
