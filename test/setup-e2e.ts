 ...
 * `jest-e2e.json` делал 68 наборов строго последовательными. Тесты внутри
 * набора занимают доли секунды — почти все 8.5 минуты уходили на то, что каждый
 * набор поднимает целиком `AppModule` (~7 с × 68). Параллелить мешала общая
 * база: наборы затирали бы данные друг друга.
 *
